...
const DataTable = ({ displayTable }) => {
  const { tableData } = useContext(RightColumnContext);
  ...
  return (
    displayTable && (
      <div
        className='flex flex-col text-black max-w-2xl mx-auto mt-10 bg-second shadow-md rounded-lg overflow-hidden
      '
      >
